...
describe('Celeb e2e test', () => {
  ...
  it('should load Celebs', async () => {
    ...
    expect(await celebComponentsPage.getTitle()).to.eq('springgoodApp.celeb.home.title');
  ...
  it('should load create Celeb page', async () => {
    ...
    expect(await celebUpdatePage.getPageTitle()).to.eq('springgoodApp.celeb.home.createOrEditLabel');
  ...
  it('should delete last Celeb', async () => {
    ...
    expect(await celebDeleteDialog.getDialogTitle()).to.eq('springgoodApp.celeb.delete.question');
