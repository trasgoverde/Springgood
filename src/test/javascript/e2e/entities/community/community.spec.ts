...
describe('Community e2e test', () => {
  ...
  it('should load Communities', async () => {
    ...
    expect(await communityComponentsPage.getTitle()).to.eq('springgoodApp.community.home.title');
  ...
  it('should load create Community page', async () => {
    ...
    expect(await communityUpdatePage.getPageTitle()).to.eq('springgoodApp.community.home.createOrEditLabel');
  ...
  /* it('should create and save Communities', async () => {
        ...
        await promise.all([
            ...
            communityUpdatePage.calbumSelectLastOption(),
        ]);
  ...
  /* it('should delete last Community', async () => {
        ...
        expect(await communityDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.community.delete.question');
