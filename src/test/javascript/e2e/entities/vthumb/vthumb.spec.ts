...
describe('Vthumb e2e test', () => {
  ...
  it('should load Vthumbs', async () => {
    ...
    expect(await vthumbComponentsPage.getTitle()).to.eq('springgoodApp.vthumb.home.title');
  ...
  it('should load create Vthumb page', async () => {
    ...
    expect(await vthumbUpdatePage.getPageTitle()).to.eq('springgoodApp.vthumb.home.createOrEditLabel');
  ...
  /* it('should delete last Vthumb', async () => {
        ...
        expect(await vthumbDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.vthumb.delete.question');
