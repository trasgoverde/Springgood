...
describe('Photo e2e test', () => {
  ...
  it('should load Photos', async () => {
    ...
    expect(await photoComponentsPage.getTitle()).to.eq('springgoodApp.photo.home.title');
  ...
  it('should load create Photo page', async () => {
    ...
    expect(await photoUpdatePage.getPageTitle()).to.eq('springgoodApp.photo.home.createOrEditLabel');
  ...
  it('should delete last Photo', async () => {
    ...
    expect(await photoDeleteDialog.getDialogTitle()).to.eq('springgoodApp.photo.delete.question');
