...
describe('Comment e2e test', () => {
  ...
  it('should load Comments', async () => {
    ...
    expect(await commentComponentsPage.getTitle()).to.eq('springgoodApp.comment.home.title');
  ...
  it('should load create Comment page', async () => {
    ...
    expect(await commentUpdatePage.getPageTitle()).to.eq('springgoodApp.comment.home.createOrEditLabel');
  ...
  /* it('should delete last Comment', async () => {
        ...
        expect(await commentDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.comment.delete.question');
