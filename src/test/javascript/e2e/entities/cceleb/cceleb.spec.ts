...
describe('Cceleb e2e test', () => {
  ...
  it('should load Ccelebs', async () => {
    ...
    expect(await ccelebComponentsPage.getTitle()).to.eq('springgoodApp.cceleb.home.title');
  ...
  it('should load create Cceleb page', async () => {
    ...
    expect(await ccelebUpdatePage.getPageTitle()).to.eq('springgoodApp.cceleb.home.createOrEditLabel');
  ...
  it('should delete last Cceleb', async () => {
    ...
    expect(await ccelebDeleteDialog.getDialogTitle()).to.eq('springgoodApp.cceleb.delete.question');
