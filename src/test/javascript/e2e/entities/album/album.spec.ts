...
describe('Album e2e test', () => {
  ...
  it('should load Albums', async () => {
    ...
    expect(await albumComponentsPage.getTitle()).to.eq('springgoodApp.album.home.title');
  ...
  it('should load create Album page', async () => {
    ...
    expect(await albumUpdatePage.getPageTitle()).to.eq('springgoodApp.album.home.createOrEditLabel');
  ...
  /* it('should delete last Album', async () => {
        ...
        expect(await albumDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.album.delete.question');
