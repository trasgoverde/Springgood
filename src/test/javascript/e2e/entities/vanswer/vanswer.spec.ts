...
describe('Vanswer e2e test', () => {
  ...
  it('should load Vanswers', async () => {
    ...
    expect(await vanswerComponentsPage.getTitle()).to.eq('springgoodApp.vanswer.home.title');
  ...
  it('should load create Vanswer page', async () => {
    ...
    expect(await vanswerUpdatePage.getPageTitle()).to.eq('springgoodApp.vanswer.home.createOrEditLabel');
  ...
  /* it('should delete last Vanswer', async () => {
        ...
        expect(await vanswerDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.vanswer.delete.question');
