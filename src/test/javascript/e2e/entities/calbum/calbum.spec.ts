...
describe('Calbum e2e test', () => {
  ...
  it('should load Calbums', async () => {
    ...
    expect(await calbumComponentsPage.getTitle()).to.eq('springgoodApp.calbum.home.title');
  ...
  it('should load create Calbum page', async () => {
    ...
    expect(await calbumUpdatePage.getPageTitle()).to.eq('springgoodApp.calbum.home.createOrEditLabel');
  ...
  /* it('should delete last Calbum', async () => {
        ...
        expect(await calbumDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.calbum.delete.question');
