...
describe('Topic e2e test', () => {
  ...
  it('should load Topics', async () => {
    ...
    expect(await topicComponentsPage.getTitle()).to.eq('springgoodApp.topic.home.title');
  ...
  it('should load create Topic page', async () => {
    ...
    expect(await topicUpdatePage.getPageTitle()).to.eq('springgoodApp.topic.home.createOrEditLabel');
  ...
  it('should delete last Topic', async () => {
    ...
    expect(await topicDeleteDialog.getDialogTitle()).to.eq('springgoodApp.topic.delete.question');
