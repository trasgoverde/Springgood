...
describe('Notification e2e test', () => {
  ...
  it('should load Notifications', async () => {
    ...
    expect(await notificationComponentsPage.getTitle()).to.eq('springgoodApp.notification.home.title');
    await browser.wait(
  ...
  it('should load create Notification page', async () => {
    ...
    expect(await notificationUpdatePage.getPageTitle()).to.eq('springgoodApp.notification.home.createOrEditLabel');
  ...
  /* it('should delete last Notification', async () => {
        ...
        expect(await notificationDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.notification.delete.question');
