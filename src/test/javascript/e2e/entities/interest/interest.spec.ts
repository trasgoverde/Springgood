...
describe('Interest e2e test', () => {
  ...
  it('should load Interests', async () => {
    ...
    expect(await interestComponentsPage.getTitle()).to.eq('springgoodApp.interest.home.title');
  ...
  it('should load create Interest page', async () => {
    ...
    expect(await interestUpdatePage.getPageTitle()).to.eq('springgoodApp.interest.home.createOrEditLabel');
  ...
  it('should delete last Interest', async () => {
    ...
    expect(await interestDeleteDialog.getDialogTitle()).to.eq('springgoodApp.interest.delete.question');
