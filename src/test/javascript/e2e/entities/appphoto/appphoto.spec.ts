...
describe('Appphoto e2e test', () => {
  ...
  it('should load Appphotos', async () => {
    ...
    expect(await appphotoComponentsPage.getTitle()).to.eq('springgoodApp.appphoto.home.title');
  ...
  it('should load create Appphoto page', async () => {
    ...
    expect(await appphotoUpdatePage.getPageTitle()).to.eq('springgoodApp.appphoto.home.createOrEditLabel');
  ...
  /* it('should delete last Appphoto', async () => {
        ...
        expect(await appphotoDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.appphoto.delete.question');
