...
describe('Follow e2e test', () => {
  ...
  it('should load Follows', async () => {
    ...
    expect(await followComponentsPage.getTitle()).to.eq('springgoodApp.follow.home.title');
  ...
  it('should load create Follow page', async () => {
    ...
    expect(await followUpdatePage.getPageTitle()).to.eq('springgoodApp.follow.home.createOrEditLabel');
  ...
  it('should delete last Follow', async () => {
    ...
    expect(await followDeleteDialog.getDialogTitle()).to.eq('springgoodApp.follow.delete.question');
