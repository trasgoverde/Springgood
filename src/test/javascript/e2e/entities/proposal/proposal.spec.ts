...
describe('Proposal e2e test', () => {
  ...
  it('should load Proposals', async () => {
    ...
    expect(await proposalComponentsPage.getTitle()).to.eq('springgoodApp.proposal.home.title');
  ...
  it('should load create Proposal page', async () => {
    ...
    expect(await proposalUpdatePage.getPageTitle()).to.eq('springgoodApp.proposal.home.createOrEditLabel');
  ...
  it('should delete last Proposal', async () => {
    ...
    expect(await proposalDeleteDialog.getDialogTitle()).to.eq('springgoodApp.proposal.delete.question');
