...
describe('Vtopic e2e test', () => {
  ...
  it('should load Vtopics', async () => {
    ...
    expect(await vtopicComponentsPage.getTitle()).to.eq('springgoodApp.vtopic.home.title');
  ...
  it('should load create Vtopic page', async () => {
    ...
    expect(await vtopicUpdatePage.getPageTitle()).to.eq('springgoodApp.vtopic.home.createOrEditLabel');
  ...
  /* it('should delete last Vtopic', async () => {
        ...
        expect(await vtopicDeleteDialog.getDialogTitle())
            .to.eq('springgoodApp.vtopic.delete.question');
