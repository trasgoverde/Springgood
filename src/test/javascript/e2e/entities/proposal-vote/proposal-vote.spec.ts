...
describe('ProposalVote e2e test', () => {
  ...
  it('should load ProposalVotes', async () => {
    ...
    expect(await proposalVoteComponentsPage.getTitle()).to.eq('springgoodApp.proposalVote.home.title');
    await browser.wait(
  ...
  it('should load create ProposalVote page', async () => {
    ...
    expect(await proposalVoteUpdatePage.getPageTitle()).to.eq('springgoodApp.proposalVote.home.createOrEditLabel');
  ...
  it('should delete last ProposalVote', async () => {
    ...
    expect(await proposalVoteDeleteDialog.getDialogTitle()).to.eq('springgoodApp.proposalVote.delete.question');
