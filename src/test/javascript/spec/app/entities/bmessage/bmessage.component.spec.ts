...
import { BmessageComponent } from 'app/entities/bmessage/bmessage.component';
...
describe('Component Tests', () => {
  describe('Bmessage Management Component', () => {
    let comp: BmessageComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BmessageComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.bmessages && comp.bmessages[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
