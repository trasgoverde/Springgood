...
public class Vquestion implements Serializable {
    ...
    @NotNull
    @JsonIgnoreProperties(value = "vquestions", allowSetters = true)
    ...
    public Vquestion appusers(Set<Appuser> appusers) {
        this.appusers = appusers;
        return this;
    }

    public Vquestion addAppuser(Appuser appuser) {
        this.appusers.add(appuser);
        appuser.setVquestion(this);
        return this;
    }

    public Vquestion removeAppuser(Appuser appuser) {
        this.appusers.remove(appuser);
        appuser.setVquestion(null);
        return this;
    }
