...
public class Community implements Serializable {
    ...
    public Community appusers(Set<Appuser> appusers) {
        this.appusers = appusers;
        return this;
    }

    public Community addAppuser(Appuser appuser) {
        this.appusers.add(appuser);
        appuser.setCommunity(this);
        return this;
    }

    public Community removeAppuser(Appuser appuser) {
        this.appusers.remove(appuser);
        appuser.setCommunity(null);
        return this;
    }
    ...
    public Community calbum(Calbum calbum) {
        this.calbum = calbum;
        return this;
    }
