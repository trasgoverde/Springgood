...
public class Post implements Serializable {
    ...
    public Post appusers(Set<Appuser> appusers) {
        this.appusers = appusers;
        return this;
    }

    public Post addAppuser(Appuser appuser) {
        this.appusers.add(appuser);
        appuser.setPost(this);
        return this;
    }

    public Post removeAppuser(Appuser appuser) {
        this.appusers.remove(appuser);
        appuser.setPost(null);
        return this;
    }
