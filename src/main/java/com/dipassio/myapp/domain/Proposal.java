...
public class Proposal implements Serializable {
    ...
    public Proposal appusers(Set<Appuser> appusers) {
        this.appusers = appusers;
        return this;
    }

    public Proposal addAppuser(Appuser appuser) {
        this.appusers.add(appuser);
        appuser.setProposal(this);
        return this;
    }

    public Proposal removeAppuser(Appuser appuser) {
        this.appusers.remove(appuser);
        appuser.setProposal(null);
        return this;
    }
