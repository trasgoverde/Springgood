...
import com.dipassio.myapp.domain.Activity;
import com.dipassio.myapp.repository.ActivityRepository;
...
/**
 * REST controller for managing {@link com.dipassio.myapp.domain.Activity}.
 */
@RestController
@RequestMapping("/api")
@Transactional
