...
export class PostService {
  ...
  protected convertDateFromClient(post: IPost): IPost {
    const copy: IPost = Object.assign({}, post, {
      creationDate: post.creationDate && post.creationDate.isValid() ? post.creationDate.toJSON() : undefined,
      publicationDate: post.publicationDate && post.publicationDate.isValid() ? post.publicationDate.toJSON() : undefined,
    });
    return copy;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((post: IPost) => {
        ...
        post.publicationDate = post.publicationDate ? moment(post.publicationDate) : undefined;
      });
    }
    return res;
  }
